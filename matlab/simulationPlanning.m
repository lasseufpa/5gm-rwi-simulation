...
diffusionScattering=0; %enabled or not
if diffusionScattering==1
    ...
    TstartSim=[66 198]/2; %time estimated by Pedro for 1 Rx (seconds)
    TperRxSim=[5 10]/2; %time estimated by Pedro for adding an extra Rx (seconds)
end
