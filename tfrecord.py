...
def to_tfrecord(object_file_name, paths_file_name, tfrecord_file_name, resolution=1, antenna_number=4):
...
if __name__ == '__main__':
    run_dir = os.path.join(results_dir, "run{:05d}".format(0))
    ...
    to_tfrecord(object_file_name, paths_file_name, 'rwi.tfrecord', 1)